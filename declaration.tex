...
\usepackage{di} % needs xelatex
\begin{document}

\begin{center}
\fontspec{GARA.TTF}[Path = /cygdrive/c/Windows/Fonts/] % for Cygwin environment
\Huge{}I\huge{}N \Huge CONGRESS, J\huge{}ULY \Huge 4, 1776.
\end{center}

\noindent\fontspec{OLDENGL.TTF}[Path = /cygdrive/c/Windows/Fonts/]
...
\fontspec{OLDENGL.TTF}[Path = /cygdrive/c/Windows/Fonts/]We,
therefore, \rmfamily the Representatives of the
\fontspec{OLDENGL.TTF}[Path = /cygdrive/c/Windows/Fonts/] United
...
are, and of Right ought to be \fontspec{OLDENGL.TTF}[Path =
